...
public class DataInitializer implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        //comment the ones below to only create roles first
        //then uncomment them and re-run the application for relevant users creation
    ...
    private void createDefaultAdminIfNotExists() {
        Collection<Role> adminRole = roleRepository.findByName("ROLE_ADMIN");
        for (int i = 1; i <= 2; i++) {
